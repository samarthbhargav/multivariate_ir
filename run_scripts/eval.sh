...
export MODEL_CACHE_DIR=/path/to/hfcache
export DATA_CACHE_DIR=/path/to/hfcache
export IR_DATASETS_HOME=/path/to/irdhome
export IR_DATASETS_TMP=/path/to/irdtemp
