...
#BIER_DATASETS=( "cqadupstack-mathematica" "arguana" "climate-fever" "fever" "hotpotqa" "nfcorpus" "nq" "quora" "scidocs" "webis-touche2020" )
BIER_DATASETS=( "cqadupstack-mathematica" )
BATCH_SIZE=128
